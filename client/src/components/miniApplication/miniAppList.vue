  ...
  <div class="miniApplist-wrapper">
    ...
    <div class="applist-header">
      <div class="left" style="position: relative">
        ...
        ></div>
        <el-button class="uploadWrapper button-style-main" @click="addMiniApp"
          ><i class="el-icon-plus"></i>新建小程序</el-button
        >
      </div>
    </div>

    <!--应用列表-->
    <miniAppItem :dataArr="this.dataList" @gotoAppDetail="gotoAppDetail">
    </miniAppItem>
...
export default {
  ...
  methods: {
    loadAppList() {
      MiniApi.getAppList(this.currentTeam.id).then(
        response => {
          this.dataList = [];
