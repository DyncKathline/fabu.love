  ...
  <div class="headernav-wrapper">
    <div class="leftWrapper">
      ...
      <div class="team">
        ...
        >
          <ul>
            <li
              class="leftWrapper-item"
              v-for="(item, index) in this.teamArr"
              :key="index"
        ...
        <el-button class="teamBtn" v-popover:popover @click="clickTeamBtn"
    ...
    <div class="rightWrapper">
      ...
      <div
        class="userwrapper"
        @click="clickUserIcon"
        @mouseover="userInfoHovered"
        @mouseout="userInfoUnhovered"
      >
      ...
      <ul
        class="userInfoSubWrapper"
        v-show="this.userHover"
        @mouseover="userInfoHovered"
        @mouseout="userInfoUnhovered"
      >
