      ...
      >
        <div class="userWrapper">
          ...
          <div class="userInfo-name-token">
            ...
            <div v-show="hasApiToken" class="userInfo-apiToken-contain">
              ...
              <button
                class="reset-button"
                @click="apiTokenAction"
                title="点击重置ApiToken"
              >
                <img
                  style="{width: 24; height: 24px;}"
                  src="../../assets/btn_redraw@2x.png"
                />
              </button>
            </div>
          </div>
          <div v-show="!hasApiToken">
            <el-button
              class="userInfo-apiToken-initButton"
              type="primary"
              @click="apiTokenAction"
              round
              >生成ApiToken</el-button
            >
          </div>
        </div>
        ...
        <ul class="userInfo-wrapper-nav">
          <li
            ...
            :style="getactiveClass(item)"
            :key="item"
            class="userInfo-wrapper-nav-sub"
        ...
        <personalInfo
          ...
          v-if="this.currentItem === '个人资料'"
          @cancel="cancel"
        ></personalInfo>
        <changePassword
          v-if="this.currentItem === '修改密码'"
          @cancel="cancel"
        ></changePassword>
      </div>
    </transition>
...
import { getUserInfo, saveUserInfo } from "../../mgr/userMgr";
import { apiTokenActive } from "../../api/moudle/userApi";
