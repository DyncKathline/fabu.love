<template>
  <div class="appsetting-wrapper">
    <div class="top"><i class="el-icon-setting"></i> 设置</div>
    <div class="content">
      <el-form labelWidth="150px" label-position="left">
        ...
        <el-form-item label="新版本内测发布方式">
          ...
          <el-radio v-model="pulishType" label="自动发布"
            >上传新版本后自动立即发布</el-radio
          >
        </el-form-item>
      </el-form>
      ...
      <button
        type="button"
        class="bottomBtn button-style-border"
        @click="clickSure"
      >
        立即生效
      </button>
...
export default {
  ...
  mounted() {
    ...
    this.pulishType =
      this.appInfo.autoPublish === true ? "自动发布" : "手动发布";
