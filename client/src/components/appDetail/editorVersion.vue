      ...
      >
        ...
        <el-form label-position="left" labelWidth="100px">
          ...
          <el-form-item label="文件大小">
            <p class="versioninput">
              {{ (this.versionInfo.size / 1024 / 1024).toFixed(2) }}M
            </p>
          </el-form-item>
          <el-form-item label="下载次数">
            <p
              ...
              v-html="getDownLoadCount(this.versionInfo.downloadCount)"
            ></p>
            /<span
              style="color: #9B9B9B;display: inline-block"
              v-html="getAllowDownLoadCount(this.versionInfo.strategy)"
            ></span>
          </el-form-item>
