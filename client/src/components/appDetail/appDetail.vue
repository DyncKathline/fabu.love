<template>
  <div>
    <!--头部-->
    <appDetailHeader :appInfo="this.appInfo" v-show="this.appInfo.id">
    </appDetailHeader>
    ...
    <appSetting v-if="showAppSetting" :appInfo="appInfo"> </appSetting>
  </div>
</template>
    ...
    getAppDetailData() {
      AppResourceApi.getAppDetail(
        ...
        res => {
          ...
          this.subTitleArr.push(
            this.axios.defaults.baseURL + this.appInfo.shortUrl
          );
