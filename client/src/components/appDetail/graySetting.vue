      ...
      >
        ...
        <el-form label-position="left" label-width="100px">
          ...
          <el-form-item label="下载次数限制">
            ...
            <input
              v-model="downloadNuber"
              type="text"
              style="width: 72px;border-bottom: solid 1px #eee;text-align: center"
            />
          ...
          <el-form-item label="">
            <div class="listerapper">
              ...
              <ul class="ipweapper">
                <li
                  class="ipitem"
                  v-for="(item, index) in this.ipList"
                  :key="index"
                >
                  <p v-html="item"></p>
        ...
        <el-button round class="elbutton-style sureBtn" @click="sure"
          >确认</el-button
        >
        <el-button round class="elbutton-style cancelBtn" @click="cancel"
          >取消</el-button
        >
      </div>
    </transition>
  ...
  methods: {
    ...
    setupData() {
      ...
      if (
        ...
        this.appInfo.grayStrategy.downloadCountLimit === 0
      ) {
    ...
    sure() {
      ...
      AppResourceApi.grayVersion(getUserTeam().id, this.appInfo.id, body).then(
        res => {
          console.log(res);
