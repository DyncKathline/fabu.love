<template>
  <div class="teamMgr">
    <div
      style="width: 120px;height: 16px;background-color: #6477F2;position: absolute;top: 30px;right: 72px;border-radius: 10px;filter: blur(10px);z-index: -1"
    ></div>
    <el-button class="uploadWrapper button-style-main" @click="createTeam">
      <img
        style="{width: 12; height: 12px;}"
        src="../../assets/ic_add@2x.png"
      />
      <label> 新建团队</label>
    </el-button>
