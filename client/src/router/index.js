...
export default new Router({
  ...
  routes: [
      ...
      children: [
        {
          path: "/apps",
          component: resolve =>
            require(["@/components/appList/appList.vue"], resolve)
        },
        {
          path: "/app/:appId",
          name: "AppDetail",
          component: resolve =>
            require(["@/components/appDetail/appDetail.vue"], resolve)
        },
        {
          path: "/members",
          name: "TeamMgr",
          component: resolve =>
            require(["@/components/team/teamMgr.vue"], resolve)
        },
        {
          path: "/miniAppList",
          name: "MiniAppList",
          component: resolve =>
            require(["@/components/miniApplication/miniAppList.vue"], resolve)
        },
        {
          path: "/miniApp/:appId",
          name: "MiniAppDetail",
          component: resolve =>
            require(["@/components/miniApplication/miniAppDetail.vue"], resolve)
        }
      ]
    },
    {
    ...
    },
    {
      ...
      name: "AppPreView",
      component: resolve =>
        require(["@/components/appDetail/appPreView.vue"], resolve)
    }
  ]
});
